...
class DifferentialDrive:
    ...
    async def straight(self, distance: float, max_effort: float = 0.5, timeout: float = None, main_controller: Controller = None, secondary_controller: Controller = None) -> bool:
        """
        ...
        while True:
            ...
            await asyncio.sleep(0.001) # Changed from time.sleep
    ...
    async def turn(self, turn_degrees: float, max_effort: float = 0.5, timeout: float = None, main_controller: Controller = None, secondary_controller: Controller = None, use_imu:bool = False) -> bool: # Changed to async def
        """
    ...
    #def turn(self, turn_degrees: float, max_effort: float = 0.5, timeout: float = None, main_controller: Controller = None, secondary_controller: Controller = None, use_imu:bool = False) -> bool:
    #    """
    #    Turn the robot some relative heading given in turnDegrees, and exit function when the robot has reached that heading.
    #    effort is bounded from -1 (turn counterclockwise the relative heading at full speed) to 1 (turn clockwise the relative heading at full speed)
    #    Uses the IMU to determine the heading of the robot and P control for the motor controller.
